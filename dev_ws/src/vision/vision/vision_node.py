...
from helpers import warped2scan
...
class VisionNode(Node):
    ...
    def image_raw_callback(self, msg):
        ...
        preds = self.object_detector.process_frame(cv_image)
        ...
        out_driveable = self.object_detector.draw_rectangles(out_driveable, preds)
